...
namespace TCD.Drawing
{
    ...
    public class Path : NativeComponent<SafePathHandle>
    {
        ...
        public void NewFigure(double x, double y) => LibuiEx.DrawPathNewFigure(Handle, x, y);
        ...
        public void BezierTo(double c1x, double c1y, double c2x, double c2y, double endX, double endY) => LibuiEx.DrawPathBezierTo(Handle, c1x, c1y, c2x, c2y, endX, endY);
        ...
        public void AddRectangle(double x, double y, double width, double height) => LibuiEx.DrawPathAddRectangle(Handle, x, y, width, height);
        ...
        /// </summary>
        public void End() => LibuiEx.DrawPathEnd(Handle);
    }
}