    ...
    public abstract class Control : NativeComponent<SafeControlHandle>
    {
        ...
        public virtual bool Enabled
        {
            get
            {
                ...
                return Libui.Call<Libui.uiControlEnabled>()(Handle);
            }
            set
            {
        ...
        public virtual bool Visible
        {
            ...
            {
                if (IsInvalid) throw new InvalidHandleException();
                return Libui.Call<Libui.uiControlVisible>()(Handle);
            }
            set
            {
        ...
        public virtual void Enable()
        {
            if (enabled) return;
            if (IsInvalid) throw new InvalidHandleException();
            Libui.Call<Libui.uiControlEnable>()(Handle);
            enabled = true;
        }
        ...
        public virtual void Disable()
        {
            if (!enabled) return;
            if (IsInvalid) throw new InvalidHandleException();
            Libui.Call<Libui.uiControlDisable>()(Handle);
            enabled = false;
        }
        ...
        public virtual void Show()
        {
            if (visible) return;
            if (IsInvalid) throw new InvalidHandleException();
            Libui.Call<Libui.uiControlShow>()(Handle);
            visible = true;
        }
        ...
        public virtual void Hide()
        {
            if (!visible) return;
            if (IsInvalid) throw new InvalidHandleException();
            Libui.Call<Libui.uiControlHide>()(Handle);
            visible = false;
        }
