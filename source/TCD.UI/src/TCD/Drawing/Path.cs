...
namespace TCD.Drawing
{
    ...
    public class Path : NativeComponent<SafePathHandle>
    {
        ...
        public Path(FillMode mode) : base(new SafePathHandle(Libui.DrawNewPath(mode))) => FillMode = mode;
        ...
        public void NewFigure(double x, double y) => Libui.DrawPathNewFigure(Handle, x, y);
        ...
        public void NewFigureWithArc(double xCenter, double yCenter, double radius, double startAngle, double sweep, bool negative = false) => Libui.DrawPathNewFigureWithArc(Handle, xCenter, yCenter, radius, startAngle, sweep, negative);
        ...
        public void LineTo(double x, double y) => Libui.DrawPathLineTo(Handle, x, y);
        ...
        /// <param name="sweep">The sweep angle.</param>
        /// <param name="negative">Whether the sweep angle should go clockwise (<see langword="false"/>), or counterclockwise (<see langword="true"/>).</param>
        public void ArcTo(double xCenter, double yCenter, double radius, double startAngle, double sweep, bool negative) => Libui.DrawPathArcTo(Handle, xCenter, yCenter, radius, startAngle, sweep, negative);
        ...
        public void BezierTo(double c1x, double c1y, double c2x, double c2y, double endX, double endY) => Libui.DrawPathBezierTo(Handle, c1x, c1y, c2x, c2y, endX, endY);
        ...
        /// </summary>
        public void CloseFigure() => Libui.DrawPathCloseFigure(Handle);
        ...
        public void AddRectangle(double x, double y, double width, double height) => Libui.DrawPathAddRectangle(Handle, x, y, width, height);
        ...
        /// </summary>
        public void End() => Libui.DrawPathEnd(Handle);
    }
}