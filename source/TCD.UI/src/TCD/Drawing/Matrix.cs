...
#pragma warning restore IDE0032 // Use auto property
        ...
        /// </summary>
        public void SetIdentity() => Libui.DrawMatrixSetIdentity(this);
        ...
        public void Translate(double x, double y) => Libui.DrawMatrixTranslate(this, x, y);
        ...
        public void Scale(double xCenter, double yCenter, double x, double y) => Libui.DrawMatrixScale(this, xCenter, yCenter, x, y);
        ...
        public void Rotate(double x, double y, double amount) => Libui.DrawMatrixRotate(this, x, y, amount);
        ...
        public void Skew(double x, double y, double xamount, double yamount) => Libui.DrawMatrixSkew(this, x, y, xamount, yamount);
        ...
        /// <param name="src">The specified source matrix.</param>
        public static void Multiply([Out]  Matrix dest, [In]  Matrix src) => Libui.DrawMatrixMultiply(dest, src);
        ...
        public bool Invertible() => Libui.DrawMatrixInvertible(this);

        /// <summary>
        /// Inverts this matrix.
        /// </summary>
        public void Invert() => Libui.DrawMatrixInvert(this);
        ...
        {
            Libui.DrawMatrixTransformPoint(this, out double x, out double y);
        ...
        {
            Libui.DrawMatrixTransformSize(this, out double width, out double height);
