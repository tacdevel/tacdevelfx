...
namespace ControlGalleryExample
{
    ...
    public sealed class DataChoosersTab : TabPage
    {
        ...
        protected override void InitializeComponent()
        {
            ...
            buttonOpenFile.Click += (sender, e) => textboxOpenFile.Text = Window.ShowOpenFileDialog(null, out string path) ? path : "(null)";
            buttonSaveFile.Click += (sender, e) => textboxSaveFile.Text = Window.ShowSaveFileDialog(null, out string path) ? path : "(null)";

            buttonMessage.Click += (sender, e) => Window.ShowMessageBox(null, "This is a normal message box.", "More detailed information can be shown here.");
            buttonMessageErr.Click += (sender, e) => Window.ShowMessageBox(null, "This message box describes an error.", "More detailed information can be shown here.", true);
